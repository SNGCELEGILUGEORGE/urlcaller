                                ...
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                          ...
                                          <% 
                                             String date;
                                            String q1="Select distinct insdate from tbl_insresponse";
                                            ResultSet rs=obj.select(q1);
                                          
                                            while(rs.next())
                                            {
                                                 date=rs.getString("insdate");
                                                 System.out.println(date);
                                            
                                             String q2="select distinct insdata from tbl_insresponse where insdate='"+date+"'";  
                                             ResultSet rs1=obj.select(q2);  
                                              while(rs1.next())
                                            {
                                                
                                                 String data=rs1.getString("insdata");
